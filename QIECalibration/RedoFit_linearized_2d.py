...
def ShuntScan(shuntMult=1, outputDirectory = '', linkMap={},injectionCardMap={}, histoList = range(192)):
...
#   sys.exit()
    ...
    pickle.dump(pedestalVals, open("debug.p", "wb"))
    #print "-"*20
    #print "-"*20
